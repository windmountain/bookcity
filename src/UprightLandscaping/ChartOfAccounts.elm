module UprightLandscaping.ChartOfAccounts exposing (accounts)
...
accounts =
    ...
    , Account 1030 "Landscaping Supplies" Asset
    , Account 1040 "Prepaid Insurance" Asset
    , Account 1500 "Truck" Asset
    , Account 1505 "Accum. Depreciation - Truck" ContraAsset
    , Account 1510 "Equipment" Asset
    , Account 1515 "Accum. Depreciation - Equipment" ContraAsset
    ...
    -- Revenue
    , Account 4010 "Landscaping Revenue" Revenue
    , Account 4020 "Snow Removal Revenue" Revenue

    -- Operating Expenses
    , Account 6010 "Wages Expense" Expense
    , Account 6020 "Fuel Expense" Expense
